      ...
      <div className="relative ">
        ...
        <div className="grid gap-10">
          ...
          <div className="transform-heading ">
            ...
            <h2 className="max-w-[500px] text-5xl text-muted font-black uppercase  font-heading  sm:text-6xl md:text-7xl lg:text-8xl">
              EVERY
            ...
            <p className="transform-intro mt-7 max-w-[530px] text-sm leading-7 text-muted/50 sm:text-base">
              See what professional detailing can do.
              Compare the condition before and after our
              specialists bring the vehicle back to life.
            </p>
          </div>
          ...
          <div className="transform-list space-y-10 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-10 ">
