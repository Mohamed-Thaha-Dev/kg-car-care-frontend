      ...
      <div className="mx-auto max-w-7xl px-6 py-20 md:px-8">
        <div className="grid grid-cols-1 gap-14 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="mt-8">
              ...
              <p className="mt-2 text-sm text-white/60">
               ...
               <div className="footer-reveal mt-5 flex items-center gap-5">
                ...
                "
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" id="youtube"><rect width="48" height="48" fill="red" rx="24"></rect><path fill="#fff" fillRule="evenodd" d="M35.7379 14.1401C37.0229 14.486 38.0361 15.4992 38.3821 16.7842C39.0246 19.1318 38.9999 24.0247 38.9999 24.0247C38.9999 24.0247 38.9999 28.8929 38.3821 31.2405C38.0361 32.5255 37.0229 33.5387 35.7379 33.8846C33.3903 34.5024 23.9999 34.5024 23.9999 34.5024C23.9999 34.5024 14.6342 34.5024 12.2619 33.8599C10.9769 33.5139 9.96375 32.5008 9.61779 31.2158C9 28.8929 9 24 9 24C9 24 9 19.1318 9.61779 16.7842C9.96375 15.4992 11.0016 14.4613 12.2619 14.1153C14.6095 13.4976 23.9999 13.4976 23.9999 13.4976C23.9999 13.4976 33.3903 13.4976 35.7379 14.1401ZM28.8187 24L21.0098 28.4975V19.5025L28.8187 24Z" clipRule="evenodd"></path></svg>
                </a>
              </div>
          </div>
          ...
          <div className="footer-reveal">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex-col footer-link
                    group
                    flex
                    w-fit
                    gap-2
            ...
            <label >Branch (Main Branch)</label>
              <a href="https://maps.app.goo.gl/Uq7yhX77hMRrJydr5" target="__black">
                WATER TANK STOP, Thudiyalur - Saravanampatti Rd, Fathima Nagar, Coimbatore, Tamil Nadu 641029
              </a>
              </div>
            ...
            <label >Branch 2</label>
              <a href="https://maps.app.goo.gl/4pj7wh4ToTCGfvNr5" target="__black">
               1433, Sathy Rd, Ganapathy Housing Unit, Bharathi Nagar, Gopalakrishnapuram, Ganapathy, Coimbatore.
Tamilnadu-641006
              </a>
              </div>
            </div>
